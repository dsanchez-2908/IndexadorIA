...
{
    /// <summary>
    /// Pantalla de Control y Finalización de lotes procesados por IA (cdEstado=4)
    /// </summary>
    public partial class FrmControlFinalizacion : Form
    {
        private const int CD_ESTADO_CONTROL_FINALIZACION = 4;
        ...
        private void CargarLotes()
        {
            try
            {
                ...
                _lotesActuales = loteDAL.ObtenerLotesPorEstadoFiltrado(
                    CD_ESTADO_CONTROL_FINALIZACION, dsNombreLote, feAltaDesde, feAltaHasta);
