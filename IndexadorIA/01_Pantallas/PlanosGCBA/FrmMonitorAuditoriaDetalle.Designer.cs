...
{
    partial class FrmMonitorAuditoriaDetalle
    {
        ...
        private void InitializeComponent()
        {
            ...
            rbPendienteAuditoria = new RadioButton();
            rbAuditado = new RadioButton();
            ...
            btnReasignarAuditoria = new Button();
            ...
            groupBoxFiltros.Controls.Add(rbPendienteAuditoria);
            groupBoxFiltros.Controls.Add(rbAuditado);
            ...
            //
            // rbPendienteAuditoria
            //
            rbPendienteAuditoria.AutoSize = true;
            rbPendienteAuditoria.ForeColor = Color.White;
            rbPendienteAuditoria.Location = new Point(200, 43);
            rbPendienteAuditoria.Name = "rbPendienteAuditoria";
            rbPendienteAuditoria.Size = new Size(150, 19);
            rbPendienteAuditoria.TabIndex = 3;
            rbPendienteAuditoria.Text = "Pendiente de Auditoria";
            rbPendienteAuditoria.UseVisualStyleBackColor = true;
            rbPendienteAuditoria.CheckedChanged += rbFiltro_CheckedChanged;
            //
            // rbAuditado
            //
            rbAuditado.AutoSize = true;
            rbAuditado.ForeColor = Color.White;
            rbAuditado.Location = new Point(370, 43);
            rbAuditado.Name = "rbAuditado";
            rbAuditado.Size = new Size(100, 19);
            rbAuditado.TabIndex = 4;
            rbAuditado.Text = "Auditado";
            rbAuditado.UseVisualStyleBackColor = true;
            rbAuditado.CheckedChanged += rbFiltro_CheckedChanged;
            //
            // groupBoxLotes
            //
            ...
            groupBoxLotes.Text = "Lotes del Auditor";
            //
            // dgvLotes
            //
            ...
            panelAcciones.Controls.Add(btnReasignarAuditoria);
            ...
            //
            // btnReasignarAuditoria
            //
            btnReasignarAuditoria.BackColor = Color.FromArgb(0, 122, 204);
            btnReasignarAuditoria.ForeColor = Color.White;
            btnReasignarAuditoria.FlatStyle = FlatStyle.Flat;
            btnReasignarAuditoria.Location = new Point(360, 8);
            btnReasignarAuditoria.Margin = new Padding(3, 2, 3, 2);
            btnReasignarAuditoria.Name = "btnReasignarAuditoria";
            btnReasignarAuditoria.Size = new Size(170, 30);
            btnReasignarAuditoria.TabIndex = 2;
            btnReasignarAuditoria.Text = "Reasignar Auditoria";
            btnReasignarAuditoria.UseVisualStyleBackColor = false;
            btnReasignarAuditoria.Click += btnReasignarAuditoria_Click;
            //
            // btnCerrar
            //
            ...
            Name = "FrmMonitorAuditoriaDetalle";
            Text = "Detalle de Auditoria";
            Load += FrmMonitorAuditoriaDetalle_Load;
        ...
        private RadioButton rbPendienteAuditoria;
        private RadioButton rbAuditado;
        ...
        private Button btnReasignarAuditoria;
